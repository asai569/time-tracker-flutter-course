...
import 'package:my_time_tracker_flutter_course/app/sign_in/email_sign_in_bloc.dart';
...
class _EmailSignInFormBlocBased extends State<EmailSignInFormBlocBased> {
  ...
  _buildEmailTextField(EmailSignInModel model) {
    return TextField(
  ...
  _buildpasswordTextField(EmailSignInModel model) {
    return TextField(
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EmailSignInModel>(
      ...
      builder: (context, snapshpot) {
        final EmailSignInModel model = snapshpot.data;
